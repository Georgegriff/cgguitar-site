  ...
  render() {
    this.innerHTML = `
        <div class="burger-menu" data-element="burger-root">
          <button class="burger-menu__trigger" data-element="burger-menu-trigger" type="button" aria-label="Open menu for more">
  ...
  processStateChange() {
    ...
    switch (this.state.status) {
      case "closed":
        ...
        this.trigger.setAttribute("aria-label", "Open menu for more");
